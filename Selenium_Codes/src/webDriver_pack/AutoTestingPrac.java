...
//        
        ...
        //dynamic btn
        WebElement dynamicBtn=driver.findElement(By.xpath("//*[@id=\"HTML5\"]/div[1]/button"));
        dynamicBtn.click();
//        
//        //simple Alerts
//        
...
//
        ...
        WebElement newtab=driver.findElement(By.xpath("//*[@id=\"HTML4\"]/div[1]/button"));
        newtab.click();
        Thread.sleep(3000);
        Set<String> tabIDs=driver.getWindowHandles();
//        
        for (String window : tabIDs) {
...
//        
//        //PopUp windows
        WebElement newWin=driver.findElement(By.id("PopUp"));
        newWin.click();
        Thread.sleep(3000);
        Set<String> tabIDs2=driver.getWindowHandles();
        
        for (String window : tabIDs2) {
            driver.switchTo().window(window);
...
//        
       ...
       //. Use actions class to handle actions(double click, right click, mouse over , slider, drag and
  //     drop, dynamic click)
